/*************************************************
 * Linear_hash_table_tester
 * A class for testing linear hash tables.
 *
...
#ifndef LINEAR_HASH_TABLE_TESTER_H
#define LINEAR_HASH_TABLE_TESTER_H
...
class Linear_hash_table_tester:public Tester< LinearHashTable<Type> > {
	using Tester< LinearHashTable<Type> >::object;
	using Tester< LinearHashTable<Type> >::command;

	public:
		Linear_hash_table_tester( LinearHashTable<Type> *obj = 0 ):Tester< LinearHashTable<Type> >( obj ) {
			// empty
		}
...
template <typename Type>
void Linear_hash_table_tester<Type>::process() {
	if ( command == "size" ) {
